...
import 'package:trundle/pages/rental_company/vehicle_edit_screen.dart';
      ...
      body: FutureBuilder(
          ...
          builder: (context, snap) {
            ...
            return ListView.builder(
              ...
              return InkWell(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (_)=>EditVehicleScreen(vehicleId: snap.data![index]['vehicle_id'])));
                },
                child: Container(
